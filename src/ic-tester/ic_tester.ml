...
print_endline ("also: " ^ String.concat ~sep:", " aliases));
       ...
       | None -> List.iter models ~f:describe)

let trace_command models =
...
let command models =
  Command.group ~summary:""
    [
      ("show", show_command models);
      ("trace", trace_command models);
      ("test", test_command models);
      ("batch-test", batch_test_command models);
    ]
